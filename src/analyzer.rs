...
mod tests {
    ...
    /// Downloads the default test model `tyto-1.1-l-16khz` into the crate's `target/` directory.
    ...
    fn test_analyzer_pair(
        ...
        analyzer_pair(model, license_key)
            .expect("tyto-1.1-l-16khz should create a collector/analyzer pair")
    }
